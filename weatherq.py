...
# Form implementation generated from reading ui file 'weatherq.ui'
#
...
"font: 25 12pt \"Segoe UI Light\";")
    ...
    def retranslateUi(self, MainWindow):
        ...
        g = geocoder.ip('me')
        city = g.city
        API = "http://api.openweathermap.org/data/2.5/weather?appid=006d6dbf520677a12b92a3815f743041&q={}".format(city)
        ...
        aqi = "https://api.waqi.info/feed/"+city+"/?token=0574c99883d41944c6ddd40f22de31ffbf39e7b2"
